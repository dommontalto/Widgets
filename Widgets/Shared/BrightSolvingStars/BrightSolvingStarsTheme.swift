...
enum BrightSolvingStarsArchetype: Int, CaseIterable, Sendable {
    case spiral = 0
    case nebula = 1
    case core = 2
    case deepField = 3
...
enum BrightSolvingStarsState: Int, CaseIterable, Sendable {
    case idle = 0
    case listening = 1
    case thinking = 2
    case speaking = 3
...
enum BrightSolvingStarsQuality: Sendable {
    case low
    case balanced
    case high
...
struct BrightSolvingStarsAmbientMotion: Sendable {
    var isEnabled: Bool
    ...
    static let off = BrightSolvingStarsAmbientMotion(isEnabled: false, verticalTravel: 0, scale: 1, duration: 0, delay: 0)
    static let standard = BrightSolvingStarsAmbientMotion(isEnabled: true, verticalTravel: 8, scale: 1, duration: 7, delay: 0)

    func with(verticalTravel: CGFloat) -> BrightSolvingStarsAmbientMotion {
        var copy = self
...
struct BrightSolvingStarsAppearance: Sendable {
    var detail: Double = 1
    var glow: Double = 1
    var intensity: Double = 1
}

struct BrightSolvingStarsMotionTuning: Sendable {
    var drift: Double = 1
    var speed: Double = 1
}

struct BrightSolvingStarsAudioResponse: Sendable {
...
struct BrightSolvingStarsTheme: Identifiable, Sendable {
    let id: String
    let archetype: BrightSolvingStarsArchetype
    ...
    let ambientMotion: BrightSolvingStarsAmbientMotion
    // The diameter the preset was tuned at on the site.
    let referenceDiameter: CGFloat
    var appearance = BrightSolvingStarsAppearance()
    var motion = BrightSolvingStarsMotionTuning()
    var audioResponse = BrightSolvingStarsAudioResponse()
    ...
    init(
        id: String,
        archetype: BrightSolvingStarsArchetype,
        phase: Double,
        baseColor: String,
        accentColors: [String],
        referenceDiameter: CGFloat = Constants.defaultReferenceDiameter,
        lensStrength: Double? = nil,
        ambientMotion: BrightSolvingStarsAmbientMotion = .standard,
        interiorColor: String = "#000000"
    ) {
        precondition(accentColors.count == 3, "Themes carry exactly three accents.")
        self.id = id
...
extension BrightSolvingStarsTheme {
    static let `default` = coreTeal01

    static let all: [BrightSolvingStarsTheme] = [
    ...
    static func preset(id: String) -> BrightSolvingStarsTheme {
        all.first { $0.id == id } ?? .default
    }

    private static let floatingGently = BrightSolvingStarsAmbientMotion(
        isEnabled: true, verticalTravel: 5, scale: 1.03, duration: 6.5, delay: 0
    )

    static let coreTeal01 = BrightSolvingStarsTheme(
    ...
    static let spiralPink01 = BrightSolvingStarsTheme(
    ...
    static let nebulaPink01 = BrightSolvingStarsTheme(
        id: "nebula-pink-01", archetype: .nebula, phase: 4.083,
        baseColor: "#241627", accentColors: ["#FFC9E0", "#E4A8FF", "#FFE9F4"],
        referenceDiameter: 186,
        ambientMotion: BrightSolvingStarsAmbientMotion(isEnabled: true, verticalTravel: 5, scale: 1.03, duration: 7.8, delay: 0.4)
    )
    static let spiralCyan01 = BrightSolvingStarsTheme(
        id: "spiral-cyan-01", archetype: .spiral, phase: 1.285,
        baseColor: "#0A1B2E", accentColors: ["#38BDF8", "#0E7BD1", "#CFF2FF"],
        referenceDiameter: 150,
        ambientMotion: BrightSolvingStarsAmbientMotion(isEnabled: true, verticalTravel: 5, scale: 1.03, duration: 9.1, delay: 0.8)
    )
    static let spiralCyan02 = BrightSolvingStarsTheme(
    ...
    static let nebulaViolet01 = BrightSolvingStarsTheme(
    ...
    static let coreBlue01 = BrightSolvingStarsTheme(
