...
// TO DO: FOR FUTURE DAILYLOGSVIEW
...
//         WidgetsText("PROGRAM: WEEK 2/8", size: .body2, color: .defaultGreen, weight: .regular)
...
//         } action: { _, offset in
//             bannerShadowProgress = WidgetsCalendarDropShadow.progress(forOffset: offset)
//         }
//     }
//
...
//
//             if isCompact {
//                 WidgetsText(event.name, size: .body2, color: event.color, weight: .regular)
//                 Spacer()
//                 detailLabel(event)
//             } else {
...
//             }
//             WidgetsText(event.detail, size: .body2, color: event.color)
//         }
//     }
//
...
//             WidgetsText(now.formatted(.brightTime24), size: .body2, color: .defaultBlack, weight: .regular)
//                 .monospacedDigit()
...
//
//             HStack(spacing: .spacing05x) {
//                 WidgetsText("\(hour % 12 == 0 ? 12 : hour % 12)", size: .body2, weight: .regular)
//                     .monospacedDigit()
//                     .frame(width: Constants.hourLabelWidth, alignment: .trailing)
//                 WidgetsText(hour < 12 ? "AM" : "PM", size: .body2, weight: .regular)
