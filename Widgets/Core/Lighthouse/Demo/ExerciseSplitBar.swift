...
struct ExerciseSplitBar: View {
    ...
    private var bar: some View {
        GeometryReader { proxy in
            ...
            HStack(spacing: inset) {
                ...
                RoundedRectangle(cornerRadius: Constants.notchCornerRadius, style: .continuous)
                    .fill(Color.textColor)
                    .frame(width: Constants.notchWidth, height: Constants.notchHeight)
        ...
        .overlay {
            RoundedRectangle(cornerRadius: Constants.barCornerRadius, style: .continuous)
                .strokeBorder(Color.textColor.opacity(.minimalOpacity), lineWidth: Constants.hairline)
        }
    }
    ...
    private enum Constants {
        ...
        static let notchHeight: CGFloat = 21
        static let notchCornerRadius: CGFloat = 1
